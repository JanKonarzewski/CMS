...
<div id="wraper">
    ...
    <div class = "Snav">
    		<div class="form">
    			<form:form action="/CMS/homeReviewer" >
    ...
    <div id ="centerWrapper">
	   <div id="content">  
	    <c:forEach items="${articles}" var="art">
	     	  	<c:out value="Title: "/>
		      	<c:out value="${art.title}"/></br>
		      	<c:out value="Conference: "/>
		      	<c:out value="${art.conference.name}"/></br>
		      	<c:out value="Subbmision date: "/>
		      	<c:out value="${art.submitionDate}"/></br>
		      	<c:out value="Accepted: "/>
		      	<c:out value="${art.accepted}"/></br>
		      	<form:form action="/CMS/reviewerArticlesReview">
