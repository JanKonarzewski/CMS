...
<div id="wraper">
    ...
    <div class = "Snav">
    	    		<div class="form">
    		<form:form action="/CMS/ConferenceDetails" >
                <input type="submit" value="Back to conference details" >
    ...
    <div id ="centerWrapper">
	   ...
	   <h5>Submit your article</h5>
	  	<form:form action="/CMS/submitArticle" enctype="multipart/form-data">
			Article:       <input type="file" name="file">
