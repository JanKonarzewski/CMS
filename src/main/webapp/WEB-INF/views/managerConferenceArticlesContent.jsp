...
<div id="wraper">
    ...
    <div class = "Snav">
    		<div class="form">
    			<form:form action="${pageContext.request.contextPath}/manageArticles">
		    		<input type="submit" value="Back to articles" ></input>
		  			<input type="hidden" name="articleID" value="<c:out value='${articles.articleId}'/>"/>
