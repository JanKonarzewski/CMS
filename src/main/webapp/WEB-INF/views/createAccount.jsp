...
<div id="wraper">
    			...
    			<form:form action="${pageContext.request.contextPath}/conferenceDetails">
		    		<input type="submit" value="Back Conference" ></input>
		  			...
		  			<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
    		    		...
    		    		<div class="form">
    			<form:form action="/CMS/searchConferencesByName" >
                	<input type="submit" value="Browse Conferences" >
              	    <input type="hidden"  value="" name= "byName" id="byName">
              		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
	    	    </form:form>
            </div>
			<div class="form">   
                <form:form action="/CMS/articles" >
                	<input type="submit" value="Articles">
                	<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
	    	    </form:form>
            </div>
            <div class="form">   
                <form:form action="/CMS/contacts">
    ...
    <div id ="centerWrapper">
	   <div id="content">  
		<form action="/CMS/manager/createAccount">
			<input type="text" name="fname">
			<input type="text" name="lname">
			<input type="text" name="email">
			<input type="text" name="password">
			<input type="checkbox" name="Reviewer" value="Bike"><br>
			<input type="checkbox" name="Speaker" value="Car"><br>
